    ...
    it('returns the response expected by AOR for GET_LIST', () => {
        const resource = {
            type: {
                name: 'Post',
                fields: [
                    { name: 'id', type: { kind: TypeKind.NON_NULL, ofType: { kind: TypeKind.SCALAR } } },
                    { name: 'title', type: { kind: TypeKind.NON_NULL, ofType: { kind: TypeKind.SCALAR } } },
                    { name: 'tags', type: { kind: TypeKind.LIST, ofType: { kind: TypeKind.OBJECT, name: 'Tag' } } },
            ...
            resources: [
                {
                    type: {
                        ...
                        fields: [
                            ...
                            { name: 'firstName', type: { kind: TypeKind.SCALAR } },
                        ],
                    },
                },
                {
