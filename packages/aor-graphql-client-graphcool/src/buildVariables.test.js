...
describe('buildVariables', () => {
    describe('GET_LIST', () => {
        it('returns correct variables', () => {
            const introspectionResult = {
                types: [{ name: 'PostFilter', inputFields: [{ name: 'tags_some' }] }],
            };
            const params = {
                filter: {
                    ids: ['foo1', 'foo2'],
    ...
    describe('CREATE', () => {
        it('returns correct variables', () => {
            const params = {
                data: { author: { id: 'author1' }, tags: [{ id: 'tag1' }, { id: 'tag2' }], title: 'Foo' },
            };
            const queryType = {
    ...
    describe('DELETE', () => {
        it('returns correct variables', () => {
            ...
            expect(buildVariables()({ type: { name: 'Post' } }, DELETE, params, {})).toEqual({
                id: 'post1',
            });
        });
    });
